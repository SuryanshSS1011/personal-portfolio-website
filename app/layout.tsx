...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      // High-DPI versions for retina displays
      { url: "/favicon-16x16@2x.png", sizes: "16x16", type: "image/png" },
      { url: "/favicon-32x32@2x.png", sizes: "32x32", type: "image/png" },
      { url: "/favicon-48x48@2x.png", sizes: "48x48", type: "image/png" },
      { url: "/favicon-64x64@2x.png", sizes: "64x64", type: "image/png" },
    ],
    apple: [
